(function($) {
  ...
  FBPhotoBox.prototype = {
    ...
    initDOM: function() {
      ...
      html += '<a title="Full Screen" class="fbphotobox-fc-btn fbphotobox-a" style="background-image: url(http://raw.github.com/chrislam1987/FBPhotoBox/master/images/fullscreen.png);';
      ...
      html += '<a class="fbphotobox-a" title="Previous" style="background-image: url(http://raw.github.com/chrislam1987/FBPhotoBox/master/images/Arrows-LWhite-icon.png);';
      ...
      html += '<tr>';
      html += '<td style="vertical-align:middle;">';
      html += '<a class="fbphotobox-a" title="Next" style="background-image: url(http://raw.github.com/chrislam1987/FBPhotoBox/master/images/Arrows-RWhite-icon.png);background-repeat: no-repeat;background-size:auto;';
      ...
      html += '<img src="http://raw.github.com/chrislam1987/FBPhotoBox/master/images/close.png" style="height:10px;width:10px"/>';
      html += '</a>';
      ...
      html += '<a class="fbphotobox-a" title="Next" style="background-image: url(http://raw.github.com/chrislam1987/FBPhotoBox/master/images/Arrows-RWhite-icon.png);background-repeat: no-repeat;';
